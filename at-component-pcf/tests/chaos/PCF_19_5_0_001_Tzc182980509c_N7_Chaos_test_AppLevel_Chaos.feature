...
####################################################################################################
@PCF @Chaos @Tzc182980509c @P1

Feature: PCF_19_5_0_001_Tzc182980509c_N7_Chaos_test_AppLevel_Chaos

Scenario: N7_Chaos_test_AppLevel_Chaos- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_AppLevel_Chaos - One Iterations | Fail |
    ...
    ##GET IP Address of the chaosopscenter
    ...
    Given I execute the SSH command {config.global.scenario.chaos.command-start-chaosagent-applevel} at CHAOSINSTANCE
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_AppLevel_Chaos - One Iterations | Pass |
    #CICD report end#####################
