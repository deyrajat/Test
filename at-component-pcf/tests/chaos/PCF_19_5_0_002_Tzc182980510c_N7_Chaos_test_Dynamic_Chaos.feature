...
####################################################################################################
@PCF @Chaos @Tzc182980510c @P3

Feature: PCF_19_5_0_002_Tzc182980510c_N7_Chaos_test_Dynamic_Chaos

Scenario: N7_Chaos_test_Dynamic_Chaos- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_Dynamic_Chaos - One Iterations | Fail |
    ...
    Given I execute the SSH command {config.global.scenario.chaos.command-start-chaosagent-dynamic-level} at CHAOSINSTANCE
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_Dynamic_Chaos - One Iterations | Pass |
    #CICD report end#####################
