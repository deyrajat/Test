...
####################################################################################################
@PCF @Chaos @Tzc182980506c @P3

Feature: PCF_19_5_0_004_Tzc182980506c_N7_Chaos_test_Low_Chaos

Scenario: N7_Chaos_test_Low_Chaos- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_Low_Chaos - One Iterations | Fail |
    ...
    When I execute the SSH command {config.global.remotepush.location.utilities}/setPodPriority.sh {config.sut.k8s.namespace.pcf} {config.sut.k8s.namespace.cee} low at K8SMaster
    ...
    Given I execute the SSH command {config.global.scenario.chaos.command-start-low-priority} at CHAOSINSTANCE
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_Low_Chaos - One Iterations | Pass |
    #CICD report end#####################
