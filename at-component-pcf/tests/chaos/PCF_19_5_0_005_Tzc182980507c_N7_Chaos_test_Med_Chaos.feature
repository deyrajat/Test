...
####################################################################################################
@PCF @Chaos @Tzc182980507c @P2

Feature: PCF_19_5_0_005_Tzc182980507c_N7_Chaos_test_Med_Chaos

Scenario: N7_Chaos_test_Med_Chaos- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_Med_Chaos - One Iterations | Fail |
    ...
    When I execute the SSH command {config.global.remotepush.location.utilities}/setPodPriority.sh {config.sut.k8s.namespace.pcf} {config.sut.k8s.namespace.cee} med at K8SMaster
    ...
    Given I execute the SSH command {config.global.scenario.chaos.command-start-med-priority} at CHAOSINSTANCE
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | N7_Chaos_test_Med_Chaos - One Iterations | Pass |
    #CICD report end#####################
