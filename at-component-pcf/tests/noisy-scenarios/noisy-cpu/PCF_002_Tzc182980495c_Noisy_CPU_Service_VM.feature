...
#####################################################################################################
@PCF @P1 @Noisy_Scenario @Noisy_CPU @Tzc182980495c

Feature: PCF_002_Tzc182980495c_CPU_SERVICE_VM

  Scenario: Noisy CPU Test On Service VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On Service VM - Two Iterations | Fail |
 ...
 ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On Service VM - Two Iterations | Pass |
    #CICD report end#####################
