...
#####################################################################################################
@PCF @P1 @Noisy_Scenario @Noisy_CPU @Tzc182980496c 

Feature: PCF_003_Tzc182980496c_Noisy_CPU_Session_VM

  Scenario: Noisy CPU Test On Session VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On Session VM - Two Iterations | Fail |
 ...
 ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On Session VM - Two Iterations | Pass |
    #CICD report end#####################
