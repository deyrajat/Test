...
#####################################################################################################
@PCF @P2 @Noisy_Scenario @Noisy_CPU @Tzc182980497c

Feature: PCF_004_Tzc182980497c_Noisy_CPU_OAM_VM

  Scenario: Noisy CPU Test On OAM VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On OAM VM - Two Iterations | Fail |
 ...
 ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On OAM VM - Two Iterations | Pass |
    #CICD report end#####################
