...
#####################################################################################################
@PCF @P2 @Noisy_Scenario @Noisy_CPU @Tzc182980498c

Feature: PCF_005_Tzc182980498c_Noisy_CPU_Master_VM

  Scenario: Noisy CPU Test On Master VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On Master VM - Two Iterations | Fail |
 ...
 ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy CPU Test On Master VM - Two Iterations | Pass |
    #CICD report end#####################
