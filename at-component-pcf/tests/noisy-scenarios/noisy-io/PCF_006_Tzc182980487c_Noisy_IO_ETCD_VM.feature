...
#####################################################################################################
@PCF @P2 @Noisy_Scenario @Noisy_IO @Tzc182980487c 

Feature: PCF_006_Tzc182980487c_Noisy_IO_ETCD_VM

  Scenario: Noisy IO Test On ETCD VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy IO Test On ETCD VM - Two Iterations | Fail |
...
################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy IO Test On ETCD VM - Two Iterations | Pass |
    #CICD report end#####################
