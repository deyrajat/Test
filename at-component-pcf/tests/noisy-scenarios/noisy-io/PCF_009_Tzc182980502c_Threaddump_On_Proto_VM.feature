...
#####################################################################################################
@PCF @P2 @Noisy_Scenario @Noisy_IO @Tzc182980502c @ThreadDump 

Feature: PCF_009_Tzc182980502c_Threaddump_On_Proto_VM

  Scenario: Run Threaddump On Proto VM - One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Run Threaddump On Proto VM - One Iterations | Fail |
   ...
   When I execute using handler K8SMaster the SSH shell command "rm -f {config.global.scenario.noisy.threaddump-file} 2> /dev/null"
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Run Threaddump On Proto VM - One Iterations | Pass |
    #CICD report end#####################
