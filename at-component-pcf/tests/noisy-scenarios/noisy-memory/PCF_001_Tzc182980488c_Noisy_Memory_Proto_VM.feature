...
#####################################################################################################
@PCF @P1 @Noisy_Scenario @Noisy_Memory @Tzc182980488c

Feature: PCF_001_Tzc182980488c_Noisy_Memory_Proto_VM

  Scenario: Noisy Memory Test On Proto VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On Proto VM - Two Iterations | Fail |
   ...
   ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On Proto VM - Two Iterations | Pass |
    #CICD report end#####################