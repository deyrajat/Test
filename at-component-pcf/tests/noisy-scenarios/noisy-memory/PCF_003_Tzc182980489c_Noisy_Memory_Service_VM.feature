...
#####################################################################################################
@PCF @P1 @Noisy_Scenario @Noisy_Memory @Tzc182980489c 

Feature: PCF_003_Tzc182980489c_Noisy_Memory_Service_VM

  Scenario: Noisy Memory Test On Service VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On Service VM - Two Iterations | Fail |
   ...
   ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On Service VM - Two Iterations | Pass |
    #CICD report end#####################