...
#####################################################################################################
@PCF @P2 @Noisy_Scenario @Noisy_Memory @Tzc182980492c 

Feature: PCF_005_Tzc182980492c_Noisy_Memory_Master_VM

  Scenario: Noisy Memory Test On Master VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On Master VM - Two Iterations | Fail |
   ...
   ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On Master VM - Two Iterations | Pass |
    #CICD report end#####################