...
#####################################################################################################
@PCF @P2 @Noisy_Scenario @Noisy_Memory @Tzc182980493c 

Feature: PCF_006_Tzc182980493c_Noisy_Memory_ETCD_VM

  Scenario: Noisy Memory Test On ETCD VM - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On ETCD VM - Two Iterations | Fail |
   ...
   ################## Noisy Scenario Start ######################################
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Noisy Memory Test On ETCD VM - Two Iterations | Pass |
    #CICD report end#####################