...
################################################################################################
@PCF @Resiliency @Tzc182634515c @PCF_Resi_Engine @P2 @PcfResP2Set1

Feature: PCF_19_3_0_001_Tzc182634515c_Policy_Engine_Pod_Restart

  Scenario: Policy Engine Pod Restart 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Policy Engine Pod Restart - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Policy Engine Pod Restart - One Iterations | Pass |
    #CICD report end#####################
