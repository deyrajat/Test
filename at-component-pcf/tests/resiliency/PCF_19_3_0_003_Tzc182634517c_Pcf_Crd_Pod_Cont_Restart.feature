...
################################################################################################
@PCF @Resiliency @Tzc182634517c @PCF_Resi_Cfg @P2 @PcfResP2Set1

Feature: PCF_19_3_0_003_Tzc182634517c_Pcf_Crd_Pod_Cont_Restart

  Scenario: Pcf Crd Pod Container Restart 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Pcf Crd Pod Container Restart - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Pcf Crd Pod Container Restart - One Iterations | Pass |
    #CICD report end#####################
