...
################################################################################################
@PCF @Resiliency @Tzc182634518c @PCF_Resi_CDL @P1 @PcfResP1Set1 @CDET_CSCvr70147

Feature: PCF_19_3_0_004_Tzc182634518c_Pcf_Session_Pod_Cont_Restart

  Scenario: Pcf Session Pod Container Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Pcf Session Pod Container Restart - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Pcf Session Pod Container Restart - Two Iterations | Pass |
    #CICD report end#####################
