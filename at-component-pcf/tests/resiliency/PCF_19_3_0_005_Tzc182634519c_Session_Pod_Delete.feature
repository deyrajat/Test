...
################################################################################################
@PCF @Resiliency @Tzc182634519c @PCF_Resi_CDL @P2 @PcfResP2Set1 @CDET_CSCvr70147

Feature: PCF_19_3_0_005_Tzc182634519c_Session_Pod_Delete

  Scenario: Session Pod Delete 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Session Pod Delete - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Session Pod Delete - Two Iterations | Pass |
    #CICD report end#####################
