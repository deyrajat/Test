...
####################################################################################################
@PCF @Resiliency @Tzc182637341c @PCF_Resi_CDL @P1 @PcfResP1Set1 

Feature: PCF_19_3_0_008_Tzc182637341c_Admin_DB_Pod_Restart

  Scenario: AdminDB Pod Restart 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | AdminDB Pod Restart - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | AdminDB Pod Restart - One Iterations | Pass |
    #CICD report end#####################
