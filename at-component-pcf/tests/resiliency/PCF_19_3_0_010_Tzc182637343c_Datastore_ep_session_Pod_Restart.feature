...
####################################################################################################
@PCF @Resiliency @Tzc182637343c @PCF_Resi_CDL @P1 @PcfResP1Set1 @CDET_CSCvr70147

Feature: PCF_19_3_0_010_Tzc182637343c_Datastore_ep_session_Pod_Restart

  Scenario: Datastore-ep-session Pod Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Datastore-ep-session Pod Restart - Two Iterations | Fail |
    ...
    ##Perform Datastore-ep-session Pod reboot  
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Datastore-ep-session Pod Restart - Two Iterations | Pass |
    #CICD report end#####################
