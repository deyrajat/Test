...
####################################################################################################
@PCF @Resiliency @Tzc182637351c @PCF_Resi_Cfg @P2 @PcfResP2Set1

Feature: PCF_19_3_0_015_Tzc182637351c_Ops_center_pcf_ops_Pod_Restart

  Scenario: Ops-center-pcf-ops Pod Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Ops-center-pcf-ops Pod Restart - Two Iterations | Fail |
    ...
    ### Show the PCF config before Event
    Given I print:================ Show configuration before first event start ======================
    When I execute the SSH command show running-config at CLIPcfOPSCenter
    Given I print:================ Show configuration before first event stop  ====================== 
    
    ##Perform Ops-center-pcf-ops Pod reboot
    When I execute the SSH command kubectl get pod -n {config.sut.k8s.namespace.pcf} | grep --color=never ^ops-center-{config.sut.k8s.namespace.pcf}-ops | awk ' FNR == 1 {print $1}' at K8SMaster
    Then I save the SSH response in the following variables:
      | attribute      | value    |
      | (.*)           | PodName  |
    ...
    ### Show the PCF config after Event
    Given I print:================ Show configuration after first event start ======================
    When I execute the SSH command show running-config at CLIPcfOPSCenter
    Given I print:================ Show configuration after first event stop  ====================== 
    ...
    ### Show the PCF config before Event
    Given I print:================ Show configuration before second event start ======================
    When I execute the SSH command show running-config at CLIPcfOPSCenter
    Given I print:================ Show configuration before second event stop  ====================== 
    ...
    ### Show the PCF config after Event
    Given I print:================ Show configuration after second event start ======================
    When I execute the SSH command show running-config at CLIPcfOPSCenter
    Given I print:================ Show configuration after second event stop  ====================== 
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Ops-center-pcf-ops Pod Restart - Two Iterations | Pass |
    #CICD report end#####################
