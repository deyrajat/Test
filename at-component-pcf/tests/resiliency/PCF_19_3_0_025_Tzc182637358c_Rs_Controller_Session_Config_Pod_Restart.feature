...
####################################################################################################
@PCF @Resiliency @Tzc182637358c @PCF_Resi_Rs @P2 @PcfResP2Set2 

Feature: PCF_19_3_0_025_Tzc182637358c_Rs_Controller_Session_Config_Pod_Restart

  Scenario: Rs Controller Session Config Pod Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Rs Controller Session Config Pod Restart - Two Iterations | Fail |
    ...
    ##Perform Rs Controller Session Config Pod reboot  
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Rs Controller Session Config Pod Restart - Two Iterations | Pass |
    #CICD report end#####################
