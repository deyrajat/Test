...
####################################################################################################
@PCF @Resiliency @Tzc182637348c @PCF_Resi_CDL @P1 @PcfResP1Set2 @CDET_CSCvr70147

Feature: PCF_19_3_0_027_Tzc182637348c_Db_Session_Config_Pod_Restart

  Scenario: Db Session Config Pod Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Db Session Config Pod Restart - Two Iterations | Fail |
    ...
    ##Perform Db Session Config Pod reboot  
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Db Session Config Pod Restart - Two Iterations | Pass |
    #CICD report end#####################
