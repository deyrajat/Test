...
####################################################################################################
@PCF @Resiliency @Tzc182598113c @PCF_Resi_Engine @P2 @PcfResP2Set2


Feature: PCF_19_3_0_029_Tzc182598113c_Rest_ep_Pod_Delete

  Scenario: Rest Ep Pod Delete 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Rest Ep Pod Delete - Two Iterations | Fail |
    ...
    ##Perform Policy Builder Pod delete  
    When I execute the SSH command kubectl get pod -n {config.sut.k8s.namespace.pcf} | grep --color=never rest-ep | awk ' FNR == 2 {print $1}' at K8SMaster
    Then I save the SSH response in the following variables:
      | attribute      | value    |
      | (.*)           | PodName  | 
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Rest Ep Pod Delete - Two Iterations | Pass |
    #CICD report end#####################
