...
####################################################################################################
@PCF @Resiliency @Tzc182637372c @P2 @NodeNetRestart @PcfResP2Set2 

Feature: PCF_19_3_0_036_Tzc182637372c_Restart_Network_of_One_Master_VM

  Scenario: Restart Network Of  One Master VM 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart Network Of  One Master VM - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart Network Of  One Master VM - One Iterations | Pass |
    #CICD report end#####################
