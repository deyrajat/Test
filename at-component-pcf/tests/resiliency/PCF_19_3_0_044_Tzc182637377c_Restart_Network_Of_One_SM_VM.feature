...
####################################################################################################
@PCF @Resiliency @Tzc182637377c @P2 @NodeNetRestart @PcfResP2Set2 

Feature: PCF_19_3_0_044_Tzc182637377c_Restart_Network_Of_One_SM_VM

Scenario: Restart Network Of  One SM VM 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart Network Of  One SM VM - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart Network Of  One SM VM - One Iterations | Pass |
    #CICD report end#####################
