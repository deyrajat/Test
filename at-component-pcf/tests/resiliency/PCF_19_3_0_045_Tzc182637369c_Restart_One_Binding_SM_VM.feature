...
####################################################################################################
@PCF @Resiliency @Tzc182637369c @P1 @Dropped @PcfResP1Set3

Feature: PCF_19_3_0_045_Tzc182637369c_Restart_One_Binding_SM_VM

Scenario: Restart One Binding SM VM 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart One Binding SM VM - Two Iterations | Fail |
    ...
    Then I save the SSH response in the following variables:
  	...
  	When I execute the SSH command ssh -t {SSH.NodeName} "reboot"  at K8SMaster
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart One Binding SM VM - Two Iterations | Pass |
    #CICD report end#####################
