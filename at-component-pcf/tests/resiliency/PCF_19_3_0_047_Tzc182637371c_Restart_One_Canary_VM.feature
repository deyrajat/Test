...
####################################################################################################
@PCF @Resiliency @Tzc182637371c @P1 @Dropped @PcfResP1Set3

Feature: PCF_19_3_0_047_Tzc182637371c_Restart_One_Canary_VM

Scenario: Restart One Canary VM 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart One Canary VM - Two Iterations | Fail |
    ...
    Given I execute the steps from {config.global.workspace.library.location-features-validations-grafana}Benchmark.feature
 		...
 		##GET name of the Canary node.  
    When I execute the SSH command kubectl get nodes  -l smi.cisco.com/node-type=canary -o name | awk -F'/' ' FNR == 1 {print $2}' at K8SMaster
    Then I save the SSH response in the following variables:
      | attribute      | value    |
      | (.*)           | NodeName |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart One Canary VM - Two Iterations | Pass |
    #CICD report end#####################
