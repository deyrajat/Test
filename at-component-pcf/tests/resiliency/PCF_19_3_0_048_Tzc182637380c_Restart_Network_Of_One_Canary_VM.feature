...
####################################################################################################
@PCF @Resiliency @Tzc182637380c @P2 @NodeNetRestart @Dropped

Feature: PCF_19_3_0_048_Tzc182637380c_Restart_Network_Of_One_Canary_VM

Scenario: Restart Network of One Canary VM 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart Network of One Canary VM - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart Network of One Canary VM - Two Iterations | Pass |
    #CICD report end#####################
