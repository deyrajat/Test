...
####################################################################################################
@PCF @Resiliency @Tzc182686764c @PCF_NRF_Failover @P3

Feature: PCF_19_3_0_049_Tzc182686764c_NRF_Reg_Dereg_NRF_Failover

  Scenario: NRF_Reg_Dereg_NRF_Failover 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | NRF_Reg_Dereg_NRF_Failover - Two Iterations | Fail |
    ...
    When I execute using handler ToolAgentHost the SSH shell command "netstat -antlop | grep :{config.Nrf2RegPort}"
	Then I receive a SSH response and check the presence of following strings:
		| string            | occurrence  |
		| ESTABLISHED       | present     |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | NRF_Reg_Dereg_NRF_Failover - Two Iterations | Pass |
    #CICD report end#####################
