...
####################################################################################################
@PCF @Resiliency @Tzc182901072c @P1 @PcfResP1Set3 @TB4Rerun

Feature: PCF_19_3_0_056_Tzc182901072c_Etcd_Pod_Restart

  Scenario: Etcd Pod Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Etcd Pod Restart - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Etcd Pod Restart - Two Iterations | Pass |
    #CICD report end#####################
