####################################################################################################
# Date: <26/09/2019> Version: <Initial version: 19.3.0> Create by <Prosenjit Chatterjee, proschat> #
####################################################################################################
@PCF @Resiliency @Tzc182890293c @PCF_Resi_Engine @P1 @PcfResP1Set3 

Feature: PCF_19_3_0_060_Tzc182890293c_Diameter_Ep_Rx_Pod_Delete

  Scenario: Diameter Ep Rx Pod Delete 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Diameter Ep Rx Pod Delete - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Diameter Ep Rx Pod Delete - Two Iterations | Pass |
    #CICD report end#####################
