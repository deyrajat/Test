...
####################################################################################################
@PCF @Resiliency @Tzc182941510c @PCF_Resi_CDL @P2 @PcfResP2Set1

Feature: PCF_19_3_0_061_Tzc182941510c_Admin_DB_Pod_Delete

  Scenario: AdminDB Pod Delete 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | AdminDB Pod Delete - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | AdminDB Pod Delete - Two Iterations | Pass |
    #CICD report end#####################
