...
####################################################################################################
@PCF @Resiliency @Tzc182941511c @PCF_Resi_Cfg @P3

Feature: PCF_19_3_0_062_Tzc182941511c_Cps_license_manager_Pod_Delete

  Scenario: Cps-license-manager Pod Delete 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Cps-license-manager Pod Delete - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Cps-license-manager Pod Delete - One Iterations | Pass |
    #CICD report end#####################
