...
###################################################################################################
@PCF @Resiliency @Tzc182962698c @P2 @PcfResP2Set2


Feature: PCF_19_3_0_068_Tzc182962698c_Kafka_Pod_Delete

  Scenario: Kafka Pod Delete - Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Kafka Pod Delete - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Kafka Pod Delete - Two Iterations | Pass |
    #CICD report end#####################
