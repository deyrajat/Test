...
####################################################################################################
@PCF @Resiliency @Tzc182980441c @P2 @Zookeeper @PcfResP2Set2


Feature: PCF_19_3_0_071_Tzc182980441c_Zookeeper_Pod_Restart

  Scenario: Zookeeper Pod Restart 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Zookeeper Pod Restart - Two Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Zookeeper Pod Restart - Two Iterations | Pass |
    #CICD report end#####################
