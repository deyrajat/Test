...
####################################################################################################
@PCF @Resiliency @Tzc182980448c @F3190 @P3

Feature: PCF_19_3_0_074_Tzc182980448c_Update_Capacity_For_Registration

  Scenario: NRF_Update_Capacity_For_Registration 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | NRF_Update_Capacity_For_Registration - Two Iterations | Fail |
    ...
    When I execute the SSH command config ; group nrf mgmt registerGroup service type nrf nnrf-nfm endpoint-profile registerProfile endpoint-name ep2 capacity 10 ; commit ; end at CLIPcfOPSCenter
    ...
    When I execute the SSH command config ; group nrf mgmt registerGroup service type nrf nnrf-nfm endpoint-profile registerProfile endpoint-name ep2 capacity 5 ; commit ; end at CLIPcfOPSCenter
    ...
    When I execute the SSH command config ; group nrf mgmt registerGroup service type nrf nnrf-nfm endpoint-profile registerProfile endpoint-name ep2 capacity 15 ; commit ; end at CLIPcfOPSCenter
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | NRF_Update_Capacity_For_Registration - Two Iterations | Pass |
    #CICD report end#####################
