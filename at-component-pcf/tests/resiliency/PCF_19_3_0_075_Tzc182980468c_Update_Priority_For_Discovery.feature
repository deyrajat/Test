...
####################################################################################################
@PCF @Resiliency @Tzc182980468c @F3190 @P3

Feature: PCF_19_3_0_075_Tzc182980468c_Update_Priority_For_Discovery

  Scenario: NRF_Update_Priority_For_Discovery 30 MINs- Two Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | NRF_Update_Priority_For_Discovery - Two Iterations | Fail |
    ...
    When I execute the SSH command config ; group nrf discovery discoveryGroup service type nrf nnrf-disc endpoint-profile discoveryProfile endpoint-name ep2 priority 10 ; commit ; end at CLIPcfOPSCenter
    ...
    When I execute the SSH command config ; group nrf discovery discoveryGroup service type nrf nnrf-disc endpoint-profile discoveryProfile endpoint-name ep2 priority 5 ; commit ; end at CLIPcfOPSCenter
    ...
    When I execute the SSH command config ; group nrf discovery discoveryGroup service type nrf nnrf-disc endpoint-profile discoveryProfile endpoint-name ep2 priority 15 ; commit ; end at CLIPcfOPSCenter
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | NRF_Update_Priority_For_Discovery - Two Iterations | Pass |
    #CICD report end#####################
