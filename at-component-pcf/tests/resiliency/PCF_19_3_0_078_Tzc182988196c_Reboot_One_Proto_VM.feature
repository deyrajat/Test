...
####################################################################################################
@PCF @Resiliency @Tzc182988196c @P1 @CDET_CSCvs09544 @PcfResP1Set2

Feature: PCF_19_3_0_078_Tzc182988196c_Reboot_One_Proto_VM

Scenario: Reboot One Proto VM - One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Reboot One Proto VM  - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Reboot One Proto VM  - One Iterations | Pass |
    #CICD report end#####################
