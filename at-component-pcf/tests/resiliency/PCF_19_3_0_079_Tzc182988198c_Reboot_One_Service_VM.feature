...
####################################################################################################
@PCF @Resiliency @Tzc182988198c @P1 @PcfResP1Set2

Feature: PCF_19_3_0_079_Tzc182988198c_Reboot_One_Service_VM

Scenario: Reboot One Service VM - One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Reboot One Service VM  - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Reboot One Service VM  - One Iterations | Pass |
    #CICD report end#####################
