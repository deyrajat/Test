...
####################################################################################################
@PCF @Resiliency @Tzc182980556c @P1 @PcfResP1Set2 

Feature: PCF_19_3_0_082_Tzc182980556c_Drain_Rejoin_One_Service_VM

Scenario: Drain_Rejoin_One_Service_VM - One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Drain_Rejoin_One_Service_VM  - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Drain_Rejoin_One_Service_VM  - One Iterations | Pass |
    #CICD report end#####################
