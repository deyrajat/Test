...
####################################################################################################
@PCF @Resiliency @Tzc182988200c @P2 @PcfResP2Set3 

Feature: PCF_19_5_0_085_Tzc182988200c_Reboot_One_OAM_VM

Scenario: Reboot One OAM VM - One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Reboot One OAM VM  - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Reboot One OAM VM  - One Iterations | Pass |
    #CICD report end#####################
