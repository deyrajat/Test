...
####################################################################################################
@PCF @Resiliency @Tzc182980554c @P2 @PcfResP2Set3


Feature: PCF_19_5_0_088_Tzc182980554c_Drain_Rejoin_One_OAM_VM

Scenario: Drain_Rejoin_One_OAM_VM - One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Drain_Rejoin_One_OAM_VM  - One Iterations | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Drain_Rejoin_One_OAM_VM  - One Iterations | Pass |
    #CICD report end#####################
