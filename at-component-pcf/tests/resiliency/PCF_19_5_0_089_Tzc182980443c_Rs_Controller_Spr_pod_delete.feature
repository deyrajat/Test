...
#####################################################################################################
@PCF @Resiliency @Tzc182980443c @P3 @Rs_Controller_Spr

Feature: PCF_19_5_0_089_Tzc182980443c_Rs_Controller_Spr_pod_delete

  Scenario: Rs_Controller_Spr Pod Delete 30 MINs- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Rs_Controller_Spr Pod Delete - One Iterations | Fail |
    ...
    When I execute the SSH command kubectl get pod -n {config.sut.k8s.namespace.pcf} | grep --color=never ^rs-controller-spr1 | awk ' FNR == 1 {print $1}' at K8SMaster
    Then I save the SSH response in the following variables:
      | attribute      | value    |
      | (.*)           | PodName  |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Rs_Controller_Spr Pod Delete - One Iterations | Pass |
    #CICD report end#####################
