...
####################################################################################################
@PCF @Resiliency @Tzc182988190c @P3

Feature: PCF_19_5_0_093_Tzc182988190c_Restart_One_Proto_VM_longer_duration

  Scenario: Restart_One_Proto_VM_longer_duration
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_Proto_VM_longer_duration | Fail |
    ...
    ## Get the name of the Proto node 
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_Proto_VM_longer_duration | Pass |
    #CICD report end#####################
