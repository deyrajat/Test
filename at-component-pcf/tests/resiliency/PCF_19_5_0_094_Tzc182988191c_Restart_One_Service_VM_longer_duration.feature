...
####################################################################################################
@PCF @Resiliency @Tzc182988191c @P3

Feature: PCF_19_5_0_094_Tzc182988191c_Restart_One_Service_VM_longer_duration

  Scenario: Restart_One_Service_VM_longer_duration
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_Service_VM_longer_duration | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_Service_VM_longer_duration | Pass |
    #CICD report end#####################
