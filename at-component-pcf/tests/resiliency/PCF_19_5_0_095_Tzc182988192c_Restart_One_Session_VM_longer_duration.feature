...
####################################################################################################
@PCF @Resiliency @Tzc182988192c @P3 

Feature: PCF_19_5_0_095_Tzc182988192c_Restart_One_Session_VM_longer_duration

  Scenario: Restart_One_Session_VM_longer_duration
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_Session_VM_longer_duration | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_Session_VM_longer_duration | Pass |
    #CICD report end#####################
