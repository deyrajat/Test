...
####################################################################################################
@PCF @Resiliency @Tzc182988195c @P3

Feature: PCF_19_5_0_096_Tzc182988195c_Restart_One_ETCD_VM_longer_duration

  Scenario: Restart_One_ETCD_VM_longer_duration
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_ETCD_VM_longer_duration | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Restart_One_ETCD_VM_longer_duration | Pass |
    #CICD report end#####################
