...
################################################################################################
@PCF @Resiliency @Tzc183178446c @PCF_Resi_Engine @P2 @PcfResP2Set3


Feature: PCF_19_5_0_098_Tzc183178446c_consolidated_logging_Pod_Restart

  Scenario: consolidated_logging_Pod_Restart- One Iterations
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Consolidated Logging Pod Restart - One Iterations | Fail |
    ...
    When I execute the SSH command kubectl get pod -n {config.sut.k8s.namespace.pcf} | grep --color=never consolidated-logging | awk ' FNR == 1 {print $1}' at K8SMaster
    Then I save the SSH response in the following variables:
      | attribute      | value    |
      | (.*)           | PodName  |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | Consolidated Logging Pod Restart - One Iterations | Pass |
    #CICD report end#####################
