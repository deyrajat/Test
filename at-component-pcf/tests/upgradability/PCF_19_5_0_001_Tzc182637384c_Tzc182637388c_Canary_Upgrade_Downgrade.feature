...
###########################################################################################
@PCF @PCF_Canary @Tzc182637388c @Tzc182637384c

Feature: PCF_19_5_0_001_Tzc182637384c_Tzc182637388c_Canary_Upgrade_Downgrade

 @Tzc182637388c
 Scenario: PCF Canary Downgrade
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | PCF Canary Downgrade Upgrade | Fail |
    ...
    Then I update report for table {Constant.testtype} with the following details:
      | PCF Canary Downgrade Upgrade | Pass |
    #CICD report end#####################
    
  @Tzc182637384c 
  Scenario: PCF Canary Upgrade
  
    Given I print: "PCF Canary Upgrade"